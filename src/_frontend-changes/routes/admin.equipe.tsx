  ...
  return (
    <div className="space-y-5 max-w-[1200px]">
      <div className="flex items-center justify-between">
        ...
        <Button size="sm"><Plus className="h-3.5 w-3.5 mr-1.5" /> Convidar membro</Button>
      </div>
      ...
      <Card className="overflow-hidden">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-border">
            ...
            {admins.length === 0 && <tr><td colSpan={4} className="text-center py-6 text-muted-foreground">Nenhum admin configurado.</td></tr>}
          </tbody>
        </table>
      </Card>
